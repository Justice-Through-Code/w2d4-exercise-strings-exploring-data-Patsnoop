...
def confirm_ingredients():  # String methods
    ...
    print('butter''' +' ' + ingredient_2 + ' ' + ingredient_3 + ' ' + ingredient_4)
...
def favorite_bake():  # User Input/Type conversion
    ...
    # We need to put an f before the string in order to use the input from baked_good
